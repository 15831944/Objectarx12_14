...
//-----------------------------------------------------------------------------
//- Empty.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <afxdllx.h>
...
AC_IMPLEMENT_EXTENSION_MODULE(EmptyDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE EmptyExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		EmptyDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		EmptyDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
