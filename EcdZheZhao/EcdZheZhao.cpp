...
//-----------------------------------------------------------------------------
//- EcdZheZhao.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <afxdllx.h>
...
AC_IMPLEMENT_EXTENSION_MODULE(EcdZheZhaoDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE EcdZheZhaoExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		EcdZheZhaoDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		EcdZheZhaoDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
